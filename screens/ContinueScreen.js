...
const AddScreen = () => {
  ...
  const predictimage= require("../assets/predictimage.png")
  ...
  const goBackHome = () => {
    navigation.navigate('Home'); // Replace 'Home' with the actual screen name of your HomeScreen
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.hyperspectral}>Result:</Text>
        
        <Image source={predictimage} style={styles.image} />
    < Text style={styles.hyperspectral2}>Which:</Text>
        <View>
      <ColoredSquareWithText style={styles.square} color="#fde724" text="Deficient areas" />
      ...
      {/* Add more instances as needed */}
        ...
        <View style={styles.buttonContainer}>
            <TouchableOpacity onPress={goBackHome}style={styles.button1}>
